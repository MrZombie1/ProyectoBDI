...
class DrawingApplication(tkinter.Frame):
    ...
    def buildWindow(self):
        ...
        circleButton = tkinter.Button(sideBar, text = "Draw_Circle", command=circleHandler)
        circleButton.pack(fill=tkinter.BOTH)

        screen.colormode(255)
        penLabel = tkinter.Label(sideBar, text="Pen_Color")
        penLabel.pack()
        ...
        penColorButton = tkinter.Button(sideBar, text="Pick_Pen_Color", command=getPenColor)
        ...
        fillColorButton = \
            tkinter.Button(sideBar, text="Pick_Fill_Color", command=getFillColor)
        ...
        beginFillButton = tkinter.Button(sideBar, text = "Begin_Fill", command=beginFillHandler)
        ...
        endFillButton = tkinter.Button(sideBar, text="End_fill", command=endFillHandler)
        endFillButton.pack(fill=tkinter.BOTH)

        penLabel= tkinter.Label(sideBar, text="Pen_Is_Down")
        penLabel.pack()
        ...
        penUpButton = tkinter.Button(sideBar, text="Pen_Up", command=penUpHandler)
